...
44 45 0 14 -8 29 -19 35 -25 13 -27 13 -45 -6z" fill="${car.color}"/>
<path d="M10335 1991 c-60 -6 -60 -6 -57 -36 9 -69 104 -248 122 -229 57 61
210 250 207 258 -4 12 -176 17 -272 7z" fill="${car.color}"/>
<path d="M11267 1983 c-68 -5 -79 -19 -47 -60 23 -31 200 -193 210 -193 3 0
20 24 37 53 29 48 52 111 67 180 l6 27 -107 -2 c-60 -1 -134 -3 -166 -5z" fill="${car.color}"/>
...
l26 0 -7 123 c-10 179 -15 207 -36 207 -10 0 -63 -48 -119 -107z" fill="${car.color}"/>
<path d="M11035 1801 c-7 -12 -23 -144 -29 -243 -4 -77 -4 -78 19 -78 45 0
130 22 193 51 l64 29 -19 23 c-65 82 -198 227 -209 227 -7 0 -15 -4 -19 -9z" fill="${car.color}"/>
</g>
            </svg>
        `;
